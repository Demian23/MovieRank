...
final class AuthViewModel: ObservableObject{
    ...
    @discardableResult
    func createUserWithEmail(withEmail email: String, password: String) async throws -> AuthDataResult{
    ...
    @discardableResult
    func singInUserWithEmail(withEmail email: String, password: String) async throws -> AuthDataResult{
